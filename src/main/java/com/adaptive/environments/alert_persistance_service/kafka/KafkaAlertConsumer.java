package com.adaptive.environments.alert_persistance_service.kafka;


import com.adaptive.environments.alert_persistance_service.model.AlertRecord;
import com.adaptive.environments.alert_persistance_service.repository.AlertRecordRepository;
...
public class KafkaAlertConsumer {
    ...
    public KafkaAlertConsumer(KafkaReceiver<String, AlertRecord> kafkaReceiver,
                              AlertRecordRepository repository,
